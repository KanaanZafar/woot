...
TextStyle get userNameStyle {
  return TextStyle(
      color: AppColor.darkGrey, fontSize: 12, fontWeight: FontWeight.bold);
}
...
class TwitterColor {
  ...
  static final Color dodgetBlue = Color(0xFF2D7A98);
  static final Color dodgetBlue_50 = Color(0x882D7A98);
  ...
  static final Color starColor = Colors.yellow[700];
}

class AppColor {
  static final Color primary = Color(0xFF2D7A98);
