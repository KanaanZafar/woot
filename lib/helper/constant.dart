...
class AppIcon {
  static final int fabWoot = 0xf029;
  ...
  static final int rewoot = 0xf152;
  ...
  static final int addWoot = 0xf099;
...
class Language {
  ...
  Language({this.language, this.code});
}

// Hindi, Punjabi, Bangoli, urdu, etc
List<Language> languages = [
  Language(language: 'Hindi', code: 'hi'),
  Language(language: 'Punjabi', code: 'pa'),
  Language(language: 'Marathi', code: 'mr'),
  Language(language: 'Gujarati', code: 'gu'),
  Language(language: 'Kannada', code: 'kn'),
  Language(language: 'Tamil', code: 'ta'),
  Language(language: 'Bangoli', code: 'bn'),
  Language(language: 'Urdu', code: 'ur'),
  Language(language: 'Malayalam', code: 'ml'),
];
