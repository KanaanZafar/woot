...
bool validateCredentials(
    ...
    {isEmpty = false}) {
  if (isEmpty) {
    customSnackBar(_scaffoldKey, 'Please enter email id/phone number');
    return false;
...
bool validatePhoneCredentials(GlobalKey<ScaffoldState> _scaffoldKey,
    String phone, String verificationCode) {
  if (phone == null || phone.isEmpty || phone.length != 10) {
    customSnackBar(_scaffoldKey, 'Phone number must be of length 10');
    return false;
  }
  return true;
}
