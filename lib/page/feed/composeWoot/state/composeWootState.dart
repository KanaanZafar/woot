...
class ComposeWootState extends ChangeNotifier {
  ...
  /// To display userlist in compose screen two condition is required
  ...
  void onDescriptionChanged(String text, SearchState searchState) {
    ...
    /// In above description reegex is search for last username ie. `@ricky`.
  ...
  ///  } ```
  /// For more detail visit:- https://github.com/TheAlphamerc/wootter/issues/28#issue-611695533
  ...
  Future<void> sendNotificationToUser(FeedModel model, MyUser user) async {
