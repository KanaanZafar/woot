...
class ComposeBottomIconWidget extends StatefulWidget {
  ...
  final Function onTranslationTap;
  final Function onPoolIconTap;
...
class _ComposeBottomIconWidgetState extends State<ComposeBottomIconWidget> {
    ...
    return Container(
      ...
      child: Row(
        children: <Widget>[
          ...
          IconButton(
            onPressed: widget.onPoolIconTap,
            icon: Icon(
          ...
          IconButton(
            onPressed: widget.onTranslationTap,
            color: AppColor.primary,
            icon: Icon(
              Icons.translate,
              size: 19,
  ...
  void setVideo(ImageSource source) {
    ImagePicker()
        .getVideo(source: source, maxDuration: Duration(seconds: 31))
        .then((PickedFile file) {
      setState(() {
        widget.onVideoTap(File(file.path));
      });
    });
  }
